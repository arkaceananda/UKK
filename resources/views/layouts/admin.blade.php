    ...
    <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false, confirmLogout: false }">
        ...
        >
            ...
            <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('admin.meja-qr') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-arang dark:text-kertas hover:bg-kertas dark:hover:bg-arang transition-colors font-medium">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>
