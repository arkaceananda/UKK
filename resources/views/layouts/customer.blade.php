...
<body class="font-body text-arang dark:text-kertas bg-paper dark:bg-ink transition-colors duration-200 min-h-screen flex flex-col">
    <div class="flex-1 flex flex-col max-w-lg mx-auto w-full">
        ...
        <main class="flex-1 overflow-y-auto px-4 py-4" id="main-content">
            {{ $slot }}
        </main>
    </div>
